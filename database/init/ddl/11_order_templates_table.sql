...
CREATE TABLE IF NOT EXISTS `order_templates` (
  ...
  `core_fields_config` TEXT COMMENT '核心字段配置（JSON格式）',
  `extended_fields_config` TEXT COMMENT '扩展字段配置（JSON格式）',
  `business_rules_config` TEXT COMMENT '业务规则配置（JSON格式）',
  `field_mapping_config` TEXT COMMENT '字段映射配置（JSON格式）',
