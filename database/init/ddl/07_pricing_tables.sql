...
CREATE TABLE price_strategies (
    ...
    seasonality_factors JSON COMMENT '季节性因素JSON',
...
CREATE TABLE sales_targets (
    ...
    product_category_targets JSON COMMENT '商品分类目标JSON',
    regional_targets JSON COMMENT '地区目标JSON',
    commission_rate DECIMAL(5,4) COMMENT '佣金率',
    bonus_structure JSON COMMENT '奖金结构JSON',
    kpi_metrics JSON COMMENT 'KPI指标JSON',
